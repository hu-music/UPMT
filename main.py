...
parser.add_argument('--modes', default='all', help='single or all')

parser.add_argument('-l','--smpi', nargs='+',default=[-2,2,-2,2,-7,2,5,-2,2,2,-2,-7,2,5,-2,0], help='signature music pattern interval')
